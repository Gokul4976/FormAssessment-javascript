document.getElementById("permanentcheckbox").addEventListener("change", function () {
    ...
    if (this.checked) {
        permanentaddress.value = presentaddress.value.trim();
...
function validateName()
  {
    ...
    if (firstname == "") {
        ...
        document.getElementById("firstnameerror").innerText = "Firstname name must contain only letters";
        document.getElementById("firstname").style.border = "2px solid red";
        isValid = false;
...
function validatelastName()
{
    ...
    if (lastname == "") {
        ...
        document.getElementById("lastnameerror").innerText = "lastname name must contain only letters";
        document.getElementById("lastname").style.border = "2px solid red";
        isValid = false;
  ...
  function validatePhone()
  {
    ...
    if (phone == "") {
        ...
        document.getElementById("phoneerror").innerText = "enter a valid phone";
        document.getElementById("phone").style.border = "2px solid red";
        isValid = false;
  ...
  function validatePassword()
  {
    ...
    else if (password != "" && !/^[\S+\d]+$/.test(password)) {
  ...
  function validateConfirmPassword()
  {
   ...
   console.log(confirmpassword,password);
    ...
    else if (confirmpassword != "" && !/^[\S+\d]+$/.test(confirmpassword)) {
        document.getElementById("confirmpassworderror").innerText = "enter a valid Confirm password";
        document.getElementById("confirmpassword").style.border = "2px solid red";
        isValid = false;
    ...
    else if (confirmpassword!==password)
    {
        ...
        document.getElementById("confirmpassworderror").innerText = "Confirm password be same as password";
        document.getElementById("confirmpassword").style.border = "2px solid red";
        isValid = false;
    }
    else {
  ...
  function validatePresentaddress()
  {
    ...
    if (presentaddress == "") {
        document.getElementById("presentaddresserror").innerText = "present address is required";
        document.getElementById("presentaddress").style.border = "2px solid red";
        isValid = false;
    }
   
    else {
        document.getElementById("presentaddresserror").innerText = "";
  ...
  function validpermanentaddress()
  {
    ...
    if (permanentaddress == "") {
        document.getElementById("permanentaddresserror").innerText = "permanent address is required";
  ...
  function validatePresentPin()
  {
    ...
    if (presentpincode == "") {
        document.getElementById("presentpincodeerror").innerText = "present pincode is required";
        document.getElementById("presentpincode").style.border = "2px solid red";
        isValid = false;
    }
    else if (presentpincode != "" && !/^[\d]{6}$/.test(presentpincode)) {
        document.getElementById("presentpincodeerror").innerText = "enter a valid pincode";
        document.getElementById("presentpincode").style.border = "2px solid red";
        isValid = false;
        ...
        document.getElementById("presentpincodeerror").innerText = "";
  ...
  function validatePermanentPin()
  {
    ...
    if (permanentpincode == "") {
    ...
    else if (permanentpincode != "" && !/^[\d]{6}$/.test(permanentpincode)) {
        document.getElementById("permanentpincodeerror").innerText = "enter a valid pincode";
        document.getElementById("permanentpincode").style.border = "2px solid red";
        isValid = false;
        ...
        document.getElementById("permanentpincodeerror").innerText = "";
  ...
  function validatePresenstate()
  {
    ...
    if (presentstate == "") {
        document.getElementById("presentstateerror").innerText = "present state is required";
        document.getElementById("presentstate").style.border = "2px solid red";
        isValid = false;
    }
   
    else {
        document.getElementById("presentstateerror").innerText = "";
  ...
  function validatePermanentstate()
  {
    ...
    if (permanentstate == "") {
        document.getElementById("permanentstateerror").innerText = "permanent state is required";
        document.getElementById("permanentstate").style.border = "2px solid red";
        isValid = false;
    }
   
    else {
        document.getElementById("permanentstateerror").innerText = "";
  ...
  function validatelanguage()
  {
    ...
    languages.forEach((language)=>{
        if (language.checked)
        {
            languageslist.push(language.value);
  ...
  function validatephoto()
  {
    ...
    if (!photo) {
        ...
        if (!imageextensions.includes(photo.type))
        {
            document.getElementById("photoerror").innerText = "Image only allowed PNG,JPEG,JPG";
            isValid = false;
        }
        else{
...
//   document.getElementById("lang").addEventListener("mouseout",validatelanguage);
//   document.getElementsByName("interest").addEventListener("mouseout",validateinterst);

let languagebuttons=document.querySelectorAll('input[type="checkbox"][name="languages"]');
  console.log(languagebuttons);
  
  languagebuttons.forEach(radio=>{
    radio.addEventListener("mouseover",function(){
     const selectedradio=document.querySelector('input[name="languages"]:checked');
     if(!selectedradio)
     {
        console.log("1");
  ...
  document.getElementById("myform").addEventListener("submit", function (event) {
   ...
   var languageslist=[]
    ...
    console.log(languageslist.join(","));
